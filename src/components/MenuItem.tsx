...
export interface SepcialtyItemProps{
    name: string;
    image: string;
    variety: number;
}

export const SepcialtyItem: React.FC<SepcialtyItemProps> = ({name, image, variety}) => {
    return(
        <div className="rounded-tl-3xl rounded-br-3xl border-[1.5px] border-[#333F72] p-5 flex flex-col gap-5">
            ...
            <p className="flex flex-row justify-between items-end"><span className="text-2xl">{name}</span><span className="text-sm">{variety} variety</span></p>
