  ...
  return (
    <div>
      ...
      <nav className="lg:hidden">
        ...
        <div className="flex flex-row justify-around fixed bottom-0 left-0 right-0 h-20 bg-[#F3EDE1] p-8 border-t border-[#333F72] border-opacity-30 z-10 text-3xl">
          <Link to="/home#menu" className=""><GiKnifeFork/></Link>
          <Link to="/" className=""><CiShoppingBasket/></Link>
          <Link to="/about" className=""><CiCircleInfo/></Link>
